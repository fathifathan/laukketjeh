...
<!-- start header  -->
    <div class="header position-fixed top-0 start-0 w-100" style="z-index: 1030;">
    <nav class="navbar navbar-expand-lg py-0 shadow" style="background-color: #FAC039;">
        <div class="container px-4 d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center d-lg-none">
                ...
                <div class="d-flex gap-2">
                    <a href="pages/login.html">
                        <button class="btn btn-sm rounded-0 text-white" type="button" style="background-color: #2C7B3F;">login</button>
                    </a>
                </div>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="top-navbar" aria-labelledby="top-navbarLabel">
                ...
                <button class="navbar-toggler border-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#top-navbar" aria-controls="top-navbar">
                    <div class="d-flex justify-content-between p-3">
                        <img src="img/logo1.png" class="img-navbar" alt="ini logo">
            ...
            <div class="login-register d-none d-grid gap-2 d-lg-flex justify-content-center justify-content-md-end">
                <a href="pages/login.html">
                    <button class="btn me-md-1 text-white" style="background-color: #2C7B3F;" type="button">login</button>
                </a>
            </div>
        </div>
    </nav>
    ...
    <div class="carousel">
        ...
        <div class="list">
            <div class="item">
                ...
                <div class="content">
                    <div class="author">Lauk Ketjeh</div>
                    <div class="title">MENU KETJEH</div>
                    <div class="topic">NASI TUMPENG</div>
                    <div class="des">
                        <!-- lorem 50 -->
...
<div class="py-5 px-5" style="background: #2C7B3F;">

<div class="sticky-header text-center my-4">
    <h2 class="tittle fw-bold text-white">Menu Catering</h2>
  </div>

<div class="wrap" >
 <div class="sidebar-btn">
          <div class="widget p-3">
            <a href="#" class="btn btn-light w-100 fw-bold text-start mb-2">Nasi Kotak</a>
            <a href="#" class="btn btn-light w-100 fw-bold text-start mb-2">Tumpeng & Liwetan</a>
            <a href="#" class="btn btn-light w-100 fw-bold text-start mb-2">Nasi Ayam</a>
          </div>
        </div>
  <main>
...
<div class="add overflow-hidden">
  <img src="img/add.png" class="img-fluid w-100" style="object-fit: cover; width: 100%; height: auto;" alt="iklan_image">
</div>
<!-- end iklan promo -->
